...
/**
 * Archive type that would hold all of the metadata regarding .class files that would be found within particular
 * .war/.ear files etc. This type should typically sit as one of the sub archives within a {@link NestableArchive}
 *
...
public class ClassesArchive extends Archive
{
    ...
    */
   public ClassesArchive(String name, int version, List<String> manifest,
                         List<String> sign, SortedSet<String> requires,
                         SortedMap<String, Long> provides, SortedMap<String, SortedSet<String>> classDependencies,
